...
class MessageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 12.0, horizontal: 1), // 10px screen padding
      child: Column(
  ...
  Widget _buildAssistantMessage(BuildContext context) {
    ...
    return Container(
      ...
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12), // Gemini-style internal padding
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          _buildActionButton(Icons.mail_outline_rounded, 'Draft Email', () => _showEmailDraft(context)),
