  ...
  MarkdownStyleSheet _getStyleSheet(BuildContext context, {required _BlockType type}) {
    ...
    return MarkdownStyleSheet.fromTheme(theme).copyWith(
      p: theme.textTheme.bodyLarge?.copyWith(
        ...
        fontSize: type == _BlockType.metadata ? 13 : (type == _BlockType.heading ? 20 : 15),
        color: switch (type) {
        ...
        fontWeight: type == _BlockType.heading ? FontWeight.w700 : (type == _BlockType.action ? FontWeight.w500 : FontWeight.normal),
      ),
      strong: TextStyle(
